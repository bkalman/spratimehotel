...
(function(k) {
    ...
    function Ea(a) {
        ...
        var f = k(a.nScrollHead)
            ...
            , n = h.children("table");
        h = a.nScrollBody;
        var m = k(h), p = h.style, t = k(a.nScrollFoot).children("div"), v = t.children("table"), x = k(a.nTHead), r = k(a.nTable), A = r[0], E = A.style, I = a.nTFoot ? k(a.nTFoot) : null, W = a.oBrowser, M = W.bScrollOversize, C = T(a.aoColumns, "nTh"), B = [], ba = [], X = [], lb = [], Aa, Yb = function(F) {
            F = F.style;
            F.paddingTop = "0";
            F.paddingBottom = "0";
            F.borderTopWidth = "0";
    ...
    k.extend(u.ext.classes, {
        sTable: "dataTable",
        sNoFooter: "no-footer",
        sPageButton: "btn btn-outline-secondary",
        sPageButtonActive: "btn-secondary",
        sPageButtonDisabled: "btn-secondary",
        sStripeOdd: "odd",
        sStripeEven: "even",
